...
.controller('categoriaCtrl', function($scope, $state,InsumoService ,InfoService,$http,SearchMunicipioInsumo) {
  ...
  $scope.selectMunicipio = function(nameMunicipio, nameDepartamento, idM ){
      ...
      $scope.municipioDefaul.municipios = [];
      InfoService.setMunicipio(idM,nameMunicipio,nameDepartamento);
  }
      ...
      headers:headers,
            ...
            var matches = result.data.Data;
              ...
              if (matches.Favorito == false) {
                ...
                matches["titleFavorito"] = "Añadir a Favoritos";
              }else if (matches.Favorito == true) {
                matches["starFav"] = "icon-star_line_on";
                matches["titleFavorito"] = "Quitar de Favoritos";
              };
...
// controlador home
.controller('homeCtrl', ['$scope', 'InsumoService','InfoService', 'SearchMunicipioInsumo','$state',  function($scope , InsumoService,InfoService,SearchMunicipioInsumo,$state) {
  ...
  console.log(loadFister);
  console.log($scope.userLog);  
  if ($scope.userLog == true) {
    alert("si");
    if (loadFister == true) {
      alert("entro");
      InfoService.setLoadFister(false);
